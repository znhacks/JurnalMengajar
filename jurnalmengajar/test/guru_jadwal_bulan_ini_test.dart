...
class MockAuthProvider extends AuthProvider {
  ...
  @override UserModel? get currentUser => _mockUser;
  @override String? get activeSchoolId => _mockUser?.schoolId;
  @override String get activeSchoolName => _mockUser?.schoolName ?? 'SMK Test';
}
...
void main() {
  ...
  testWidgets('GuruDrawer does not contain Jadwal Bulan Ini (not on sidebar)', (tester) async {
  ...
  testWidgets('GuruJadwalBulanIniScreen renders all schedules (filled & unfilled) and allows filtering', (tester) async {
    ...
    final testClass = ClassModel(id: 'class-1', name: 'X RPL 1', periodId: 'period-1', studentCount: 30);
    final testSubject = SubjectModel(id: 'sub-1', name: 'Pemrograman Web', isActive: true);
    ...
    // Verify AppBar Title
    expect(find.text('Jadwal Mengajar Bulan Ini'), findsOneWidget);
    ...
    expect(find.text('Belum Diisi'), findsWidgets); // Status chip and card badge
