        ...
        builder: (context) => Scaffold(
          ...
          body: PdfPreview(
            build: (format) => JournalPdfService.generateJournalReportPdf(
              ...
              classes: classes,
              subjects: subjects,
              school: selectedSchool ?? authProvider.activeSchool,
              supervisorName: selectedSchool?.supervisorName ?? authProvider.activeSchool?.supervisorName,
              supervisorNip: selectedSchool?.supervisorNip ?? authProvider.activeSchool?.supervisorNip,
